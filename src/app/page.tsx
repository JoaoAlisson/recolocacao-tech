...
const categoryDescriptions: Record<ContentCategory, string> = {
  inicio:
    "Material de boas-vindas. Comece por aqui para entender o que tem disponível e a trilha sugerida.",
  guia: "Guias práticos para cada etapa crítica do processo de recolocação. Densidade alta, sem enrolação. Use como manual.",
  mapa: "Mapa de estudo dos fundamentos para vagas júnior e pleno. Independente de stack.",
};
    ...
    <div className="px-6 py-12 md:px-12 md:py-16 lg:py-20 max-w-5xl mx-auto">
      <header className="mb-16">
        ...
        <p className="text-lg md:text-xl text-zinc-400 max-w-3xl leading-relaxed">
          ...
          recolocação ou transição de carreira. Sem motivacional, sem clichês —
          só o que move o ponteiro.
        </p>
